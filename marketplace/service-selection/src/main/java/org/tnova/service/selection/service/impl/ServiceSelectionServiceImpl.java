    ...
    implements ServiceSelectionService
{
    ...
    @Value( "${tnova.orchestrator.instantiation}" )
    private String orchestratorUrl_instantiation;

    @Value( "${tnova.orchestrator.instances}" )
    private String orchestratorUrl_instances;
...
//            }
    ...
    public List<NetworkServiceInstantiateReply> getAllNsInstances()
    {
        ...
        final ResponseEntity<String> response = restTemplate.getForEntity( orchestratorUrl_instances, String.class );
...
//            throw new NsInstancesEmptyListException();
    ...
    public HttpStatus stopNetworkService( String id )
    {
        ...
        final ResponseEntity<String> responseEntity = restTemplate
            .exchange( orchestratorUrl_instances + "/{id}/stop", HttpMethod.PUT, stopRequest, String.class, params );
    ...
    public HttpStatus terminateNetworkService( String id )
    {
        ...
        {
            final ResponseEntity<String> responseEntity = restTemplate
                .exchange( orchestratorUrl_instances + "/{id}/terminate", HttpMethod.PUT, stopRequest, String.class, params );
    ...
    public String getNetworkInstanceStatus( String id )
    {
        ...
        try
        {
            responseEntity = restTemplate
                .exchange( orchestratorUrl_instances+ "/{id}/status", HttpMethod.GET, stopRequest, String.class, params );
