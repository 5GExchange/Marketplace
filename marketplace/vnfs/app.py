...
def create_vnf():
    ...
    print "VNFD DESDE MP antes de POST en NFS: ", vnfd
    ...
    try:
        ...
        for i in images:
            if True:
                ...
                image = {'url': i.nfs_image_url, 'provider_id': i.provider_id, 'image_name': i.image_name, 'version': i.image_version, 'nfs_image_name': i.nfs_image_name, 'assigned_vnfds': i.nfs_vnfd_id}
