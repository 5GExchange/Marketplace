...
INSERT INTO `django_content_type` VALUES (7,'account','account'),(9,'account','billingevent'),(8,'account','monitor'),(10,'account','slainfo'),(12,'account','slapenalty'),(11,'account','slaviolation'),(1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
