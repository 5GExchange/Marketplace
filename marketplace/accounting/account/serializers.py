...
class AccountSerializer(serializers.ModelSerializer):
   class Meta:
      model = Account
      fields = ('id', 'instanceId', 'productId', 'agreementId', 'relatives', 'relative_instances', 'productType', 'flavour', 'location', 'startDate', 'lastBillDate', 'providerId', 'clientId', 'status', 'billingModel', 'period', 'priceUnit', 'periodCost', 'setupCost', 'renew', 'dateCreated', 'dateModified')
